...
const deliveryCharges = 120  // Updated to match frontend

// Stripe Gateway initialization - only if key is provided
    ...
    try {
        ...
        const line_items = items.map((item) => ({
            price_data: {
                ...
                unit_amount: item.price * 100 // converting to BDT paisa (cents)  
            },
        ...
        line_items.push({
            price_data: {
                ...
                unit_amount: deliveryCharges * 100 // converting to BDT paisa (cents)  
            },
            quantity: 1
        })
...
// Controller function for deleting an order (Admin only)
